...
const styles = StyleSheet.create({
  ...
  categoryCard: { width: '48%', padding: 14, borderRadius: BorderRadius.lg, borderWidth: 1.5, borderColor: 'rgba(226, 232, 240, 0.5)', backgroundColor: 'rgba(255, 255, 255, 0.65)', marginBottom: 4 },
  ...
  docCard: { padding: 14, borderRadius: BorderRadius.xl, borderWidth: 1, borderColor: 'rgba(226, 232, 240, 0.5)', backgroundColor: 'rgba(255, 255, 255, 0.6)', marginBottom: 12 },
  ...
  dayScheduleCard: { padding: 12, borderRadius: BorderRadius.lg, borderWidth: 1, borderColor: 'rgba(226, 232, 240, 0.5)', backgroundColor: 'rgba(255, 255, 255, 0.55)', marginBottom: 10 },
  ...
  reviewCard: { flexDirection: 'row', alignItems: 'center', padding: 12, borderRadius: BorderRadius.lg, borderWidth: 1, borderColor: 'rgba(226, 232, 240, 0.45)', backgroundColor: 'rgba(255, 255, 255, 0.6)', marginBottom: 8 },
  ...
  modalCard: { width: '100%', maxWidth: 360, padding: 22, borderRadius: BorderRadius.xl, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.3)', ...Platform.select({ web: { backdropFilter: 'blur(24px)', WebkitBackdropFilter: 'blur(24px)' } as any, default: {} }) },
