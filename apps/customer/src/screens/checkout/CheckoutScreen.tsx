  ...
  const handlePlaceOrder = async () => {
    try {
      const orderPayload = {
        ...
        vendorId: items[0]?.storeId || 'vnd-001',
        storeId: items[0]?.storeId || 'store-1',
        storeName: 'SevaZo Dark Store',
        customerName: currentAddress?.contactName || 'Customer',
        customerPhone: currentAddress?.contactPhone || '',
